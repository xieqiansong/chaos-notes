...
工程依托：[jdk8-rocketmq-demo](https://github.com/xieqiansong/chaos-java/tree/main/mq/rocketmq-demo)（`chaos-java` 仓库，覆盖 RocketMQ 常用能力维度的 Spring Boot Demo，所有场景由 `DemoTest` 统一触发）。
...
- 关联工程：[jdk8-rocketmq-demo](https://github.com/xieqiansong/chaos-java/tree/main/mq/rocketmq-demo)
