...
工程依托：[jdk8-kafka-demo](https://github.com/xieqiansong/chaos-java/tree/main/mq/kafka-demo)（`chaos-java` 仓库，Spring Kafka，21 场景全带测试）。
...
- 工程：[jdk8-kafka-demo](https://github.com/xieqiansong/chaos-java/tree/main/mq/kafka-demo)
