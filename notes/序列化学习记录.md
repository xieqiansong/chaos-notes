...
工程依托：[jdk8-serialization-demo](https://github.com/xieqiansong/chaos-java/tree/main/engineering/serialization-demo)（`chaos-java` 仓库，用同一个 `User` 样例模型横向对比 JDK 原生 / Jackson / Kryo 三种方案，纯内存零外部依赖）。
