...
> 技术笔记仓库：**踩坑记录** + **技术学习笔记** + **性能优化**。Chaos 本意保持混乱，把精力集中在当前要做的事上。
...
| 笔记 | 主题 | 时间 |
|---|---|---|
| [Nacos 学习记录](notes/Nacos学习记录.md) | 注册中心 / 配置中心、动态刷新、编程式监听 | 2026-08 |
| [Seata 学习记录](notes/Seata学习记录.md) | 分布式事务 / AT 与 TCC 模式、undo_log、补偿 | 2026-08 |
| [Redis 学习记录](notes/Redis学习记录.md) | 缓存 / 分布式锁、限流、排行榜、管道、发布订阅 | 2026-08 |
| [Kafka 学习记录](notes/Kafka学习记录.md) | 消息队列 / 事务 exactly-once、批量消费、重试死信、自动建 Topic | 2026-08 |
| [RocketMQ 学习记录](notes/RocketMQ学习记录.md) | 消息队列 / 收发、幂等、重试死信、事务、轨迹 | 2026-07 |
